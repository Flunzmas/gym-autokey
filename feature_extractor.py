...
import config as cf
from datastructures.po_anytree import print_anytree, ast_anytree_to_node_list
...
class FeatureExtractor(object):
    ...
    def __init__(self, unnormalized_features = False, *args, **kwargs):
        '''
...
# ----------------------------------------------------------------------------------------
    ...
    def get_fitting_nodes(self, node_list, ast_category):
        '''
    ...
    def present_feature(self, nodes):
        '''
    ...
    def balance_feature(self, cat_nodes, all_nodes):
        '''
    ...
    def spread_feature(self, cat_nodes):
        '''
        ...
        cat_max = max(cat_ids)
        cat_min = min(cat_ids)
        if cat_min == cat_max: return -1.0 # no variance
...
# ----------------------------------------------------------------------------------------
    ...
    def analyze_feature_distributions(self, all_features):
        ...
        for key in all_features[0]:
            ...
            if ('balance' in key) or ('present' in key) or ('spread' in key): continue
...
# ----------------------------------------------------------------------------------------
    ...
    def validate_features(self, features):
        ...
        """
        for key in features:
            if abs(features[key]) > 1.0: return False
        return True
